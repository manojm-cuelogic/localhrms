	...
	public function save($empcommdetailsform,$userid)
	{
		...
		if($empcommdetailsform->isValid($this->_request->getPost())){
           ...
           if(!empty($new_post_values))
           {
			...
			$emergency_email_1 = $this->_request->getParam('emergency_email_1');
			$emergency_number_2 = $this->_request->getParam('emergency_number_2');
			$emergency_name_2 = $this->_request->getParam('emergency_name_2');
			$emergency_email_2 = $this->_request->getParam('emergency_email_2');
			$date = new Zend_Date();
			$actionflag = '';
			$tableid  = '';
			$data = array('user_id'=>$user_id,
								 ...
								 'emergency_email_1'=>($emergency_email_1!=''?$emergency_email_1:NULL),
								 'emergency_number_2'=>($emergency_number_2!=''?$emergency_number_2:NULL),
								 'emergency_name_2'=>($emergency_name_2!=''?$emergency_name_2:NULL),
								 'emergency_email_2'=>($emergency_email_2!=''?$emergency_email_2:NULL),
