		...
		{	
			...
			if($id == '')
			{
				...
				{		
					...
					$options['message'] .= '<div style="padding:20px 0 10px 0;">Please <a href="'.$baseUrl.'" target="_blank" style="color:#b3512f;">click here</a> to login and check the details.</div>
											</div>';	
					$options['cron'] = 'yes';
