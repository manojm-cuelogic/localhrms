...
class Default_Form_goal extends Zend_Form
{
    public function init()
    {
        $this->setMethod('post');
        $this->setAttrib('action',BASE_URL.'goal/add');
        $this->setAttrib('id', 'formid');
        $this->setAttrib('name', 'goal');
        ...
        $name->setAttrib('maxLength', 500);
        //$name->setLabel("What is your goal?");
        ...
        $this->addElements(array($id, $userid, $description, $name));
        // $name = new Zend_Form_Element_Text('name');
        // $extension_number->setAttrib('maxLength', 500);
        // $extension_number->setLabel("What is your goal?");
        ...
        // $employee_type = new Zend_Form_Element_Select('employee_type');
        // $employee_type->setLabel("Employee Type");
        // $employee_type->addMultiOption('','Select Employee Type');
        // $employee_type->setRegisterInArrayValidator(false);
        // $employee_type->setRequired(true);
        ...
        // $yearsofexp->setAttrib('maxLength', 3);
        ...
        //         $middlename->setAttrib("class", "formDataElement");
        //         $middlename->setAttrib('maxlength', 50);
        ...
        //                                  $disp_requi,$first_name,$middlename, $last_name, $employee_type));
