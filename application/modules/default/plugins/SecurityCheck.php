...
class Default_Plugin_SecurityCheck extends Zend_Controller_Plugin_Abstract
{
    ...
    public function preDispatch (Zend_Controller_Request_Abstract $request)
    {
        ...
        $withoutloginActionArr = array('index','login','loginsave','loginpopupsave','forgotpassword','editforgotpassword','sendpassword','popup','getemployeedetails', 'getemployeeleaves', 'getholidays','creditmonthlyemployeeleaves','leavereminders','cronautoapproveleave');
