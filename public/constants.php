...
defined('MANAGEMENTROLE') || define('MANAGEMENTROLE', 2);
...
defined('PUBLIC_PATH') || define('PUBLIC_PATH', $domainurl.'/public/');
...
// Added by Aju for add other details about Emloyee
defined('FUNCTIONAL_AREA') ? '' : define('FUNCTIONAL_AREA', 'Web, Admin, QA, Mobile, Front End, Hiring, Admin, Finance, Sales');
...
/*Richa defining constants for leave carry forward*/
defined('EMPLOYEE_PL_COUNT')|| define('EMPLOYEE_PL_COUNT',1.25);
defined('EMPLOYEE_SL_COUNT')|| define('EMPLOYEE_SL_COUNT',0.50);
defined('EMPLOYEE_PL_CARRYFORWARD_COUNT')|| define('EMPLOYEE_PL_CARRYFORWARD_COUNT',12);
defined('EMPLOYEE_SL_CARRYFORWARD_COUNT')|| define('EMPLOYEE_SL_CARRYFORWARD_COUNT',0);
defined('LEAVE_CANCEL_DAY')|| define('LEAVE_CANCEL_DAY',60);
